            ...
            <div class="row">
              <div class="col-md-12 form-group">
                ...
                <ValidationProvider name="email" rules="required|email" v-slot="{ errors }" :bails="false">
                    <input placeholder="Enter email address" maxlength="50" class="form-control" v-model="user.email" type="text">
                </ValidationProvider>
              </div>
              <div class="col-md-12 form-group">
                <label for="Password">Password</label>
                <ValidationProvider name="password" rules="required" v-slot="{ errors }" :bails="false">
                    <input type="password" placeholder="Enter password" maxlength="50" class="form-control" v-model="user.password">
                </ValidationProvider>
              </div>
