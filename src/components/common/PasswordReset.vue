              ...
              <div class="col-md-12 form-group">
                ...
                <div class="col-md-12 form-group">
                    <ValidationProvider name="Password" rules="required" v-slot="{ errors }">
                        ...
                        <input minlength="3" class="form-control" name="password" v-model="user.password" type="password" value="">
                    </ValidationProvider>
                </div>
                <div class="col-md-12 form-group">
                    <ValidationProvider name="Password confirmation" rules="required" v-slot="{ errors }">
                        <label for="password_confirmation">Confirm Password</label>
                        <input minlength="3" class="form-control" name="password_confirmation" v-model="user.password_confirmation" type="password" value="">
                    </ValidationProvider>
                </div>
            </div>
            <div class="row">
